...
/* Used to identify an iMX6 Quad/Dual vs. Dual Lite/Solo */
#define	MX6_CHIP_TYPE_DUAL_LITE_OR_SOLO	0x61
#define MX6_CHIP_TYPE_QUAD_OR_DUAL		0x63

/* The chip revision is used to distinguish a Quad Plus from Quad/Dual */
#define MX6_CHIP_REV_2_0                0x20
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/ipl/boards/mx6x-sabreARD/ipl_mx6x.h $ $Rev: 783570 $")
#endif
