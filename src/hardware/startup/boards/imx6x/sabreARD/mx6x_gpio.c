...
void mx6sdl_init_usdhc(void)
{
	...
	/* SD1 CLK */
	pinmux_set_swmux(SWMUX_SDL_SD1_CLK, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD1_CLK, MX6X_PAD_SETTINGS_USDHC);
	// Set the clock input to connect back to SD1_CLK port
	pinmux_set_input(SWINPUT_SDL_USDHC1_IPP_CARD_CLK_IN, 0x1);

	/* SD1 CMD */
	pinmux_set_swmux(SWMUX_SDL_SD1_CMD, MUX_CTL_MUX_MODE_ALT0 | MUX_CTL_SION);
	pinmux_set_padcfg(SWPAD_SDL_SD1_CMD, MX6X_PAD_SETTINGS_USDHC);

	/* SD1 DAT0 */
	pinmux_set_swmux(SWMUX_SDL_SD1_DAT0, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD1_DAT0, MX6X_PAD_SETTINGS_USDHC);

	/* SD1 DAT1 */
	pinmux_set_swmux(SWMUX_SDL_SD1_DAT1, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD1_DAT1, MX6X_PAD_SETTINGS_USDHC);

	/* SD1 DAT2 */
	pinmux_set_swmux(SWMUX_SDL_SD1_DAT2, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD1_DAT2, MX6X_PAD_SETTINGS_USDHC);

	/* SD1 DAT3 */
	pinmux_set_swmux(SWMUX_SDL_SD1_DAT3, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD1_DAT3, MX6X_PAD_SETTINGS_USDHC);

	/* SD1 Card Detect - configure GPIO1[1] as an input */
	pinmux_set_swmux(SWMUX_SDL_GPIO_1, MUX_CTL_MUX_MODE_ALT5);
	out32(MX6X_GPIO1_BASE + MX6X_GPIO_GDIR, in32(MX6X_GPIO1_BASE + MX6X_GPIO_GDIR) & ~(1<<1));

	/* SD1 Write Protect - configure GPIO5[20] as an input */
	pinmux_set_swmux(SWMUX_SDL_CSI0_DATA_EN, MUX_CTL_MUX_MODE_ALT5);
	out32(MX6X_GPIO5_BASE + MX6X_GPIO_GDIR, in32(MX6X_GPIO5_BASE + MX6X_GPIO_GDIR) & ~(1<<20));
	...
	/* SD3 DAT4 */
	pinmux_set_swmux(SWMUX_SDL_SD3_DAT4, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD3_DAT4, MX6X_PAD_SETTINGS_USDHC);

	/* SD3 DAT5 */
	pinmux_set_swmux(SWMUX_SDL_SD3_DAT5, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD3_DAT5, MX6X_PAD_SETTINGS_USDHC);

	/* SD3 DAT6 */
	pinmux_set_swmux(SWMUX_SDL_SD3_DAT6, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD3_DAT6, MX6X_PAD_SETTINGS_USDHC);

	/* SD3 DAT7 */
	pinmux_set_swmux(SWMUX_SDL_SD3_DAT7, MUX_CTL_MUX_MODE_ALT0);
	pinmux_set_padcfg(SWPAD_SDL_SD3_DAT7, MX6X_PAD_SETTINGS_USDHC);
