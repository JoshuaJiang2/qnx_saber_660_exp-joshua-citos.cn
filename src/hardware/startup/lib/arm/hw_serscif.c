...
void init_scif(unsigned channel, const char *init, const char *defaults)
{
	...
	baud = extclk = n = 0;
	dbg_device[channel].base = R_CAR_H2_SCIF_BASE0; //register addr same as H2
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/startup/lib/arm/hw_serscif.c $ $Rev: 788108 $")
#endif
